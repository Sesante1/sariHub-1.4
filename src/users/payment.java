...
//            try {
//                ResultSet rs = dbc.getData("SELECT * FROM sales_log WHERE Date = '" + getCurrentDate() +"'");
//                
//                if (rs.next()){
//                    
//                }
//                dbc.updateData("INSERT INTO sales_log (p_Id, total, Date) VALUES ('" + productId + "', '" + quantitySold + "', '" + getCurrentDate() + "')");
